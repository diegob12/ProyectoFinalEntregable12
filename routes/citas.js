...
router.get('/', function(req, res, next) {
  connection.query('SELECT c.id, c.fecha, pa.nombre paciente, med.nombre medico, med.consultorio FROM cita_medica c, pacientes pa, medicos med WHERE pa.cedula=cedula_paciente AND med.cedula=cedula_medico;', function(error, results) {
    if (error) {
